...
START_TEST(is_less_or_equal_13) {
  s21_decimal value_one = {{67295, 7777666, 1234567, ~(UINT_MAX >> 1)}},
              value_two = {{UINT_MAX, UINT_MAX, UINT_MAX, 0}};
  set_bit(&value_one, 127, 1);
  s21_set_scale(&value_one, 10);
  s21_set_scale(&value_two, 10);
...
START_TEST(is_equal_3) {
  s21_decimal value_one = {{0, 0, UINT_MAX, 0}},
              value_two = {{0, 0, UINT_MAX, ~(UINT_MAX >> 1)}};
  set_bit(&value_two, 127, 1);
  ck_assert_int_eq(0, s21_is_equal(value_one, value_two));
}
...
START_TEST(is_equal_5) {
  s21_decimal value_one = {0}, value_two = {0};
  set_bit(&value_one, 23, 1);
  set_bit(&value_two, 34, 1);
  ck_assert_int_eq(0, s21_is_equal(value_one, value_two));
}
...
START_TEST(is_equal_11) {
  s21_decimal value_one = {{INT32_MAX, INT32_MAX, 0, 0}},
              value_two = {{INT32_MAX, INT32_MAX, 0, 0}};
  s21_set_scale(&value_one, 13);
  s21_set_scale(&value_two, 13);
  ck_assert_int_eq(1, s21_is_equal(value_one, value_two));
}
...
START_TEST(is_equal_12) {
  s21_decimal value_one = {0}, value_two = {0};
  set_bit(&value_one, 53, 1);
  set_bit(&value_two, 53, 1);
  set_bit(&value_one, 127, 1);
  ck_assert_int_eq(0, s21_is_equal(value_one, value_two));
}
...
START_TEST(is_not_equal_11) {
  s21_decimal value_one = {{INT_MAX, INT_MAX, 0, 0}},
              value_two = {{INT_MAX, INT_MAX, 0, 0}};
  s21_set_scale(&value_one, 13);
  s21_set_scale(&value_two, 13);
  ck_assert_int_eq(0, s21_is_not_equal(value_one, value_two));
}
...
START_TEST(sub_0) {
  s21_decimal value_one = {{345668, 3455, 234355, ~(UINT_MAX >> 1)}},
...
START_TEST(sub_1) {
  s21_decimal value_one = {{345668, 3455, 234355, 0}},
              value_two = {{678567, 435, 345554, ~(UINT_MAX >> 1)}}, result;
  ck_assert_int_eq(0, s21_sub(value_one, value_two, &result));
}
...
START_TEST(sub_6) {
  s21_decimal value_one = {{123, 456, 789, ~(UINT_MAX >> 1)}},
              value_two = {{987, 654, 321, 0}}, result;
  set_bit(&value_two, 127, 1);
  set_bit(&value_one, 127, 1);
  ck_assert_int_eq(0, s21_sub(value_one, value_two, &result));
...
START_TEST(sub_12) {
  s21_decimal value_one = {{5677, 0, 0, ~(UINT_MAX >> 1)}},
...
START_TEST(sub_14) {
  s21_decimal value_one = {{UINT_MAX, UINT_MAX, UINT_MAX, 0}},
              value_two = {{667, 545, 43, ~(UINT_MAX >> 1)}}, result;
...
START_TEST(sub_15) {
  s21_decimal value_one = {{667, 545, 43, 0}},
              value_two = {{UINT_MAX, UINT_MAX, UINT_MAX, ~(UINT_MAX >> 1)}},
              result;
  ck_assert_int_eq(1, s21_sub(value_one, value_two, &result));
}
...
START_TEST(add_7) {
  s21_decimal value_one = {0}, value_two = {0}, result;
  set_bit(&value_two, 127, 1);
  set_bit(&value_two, 33, 1);
  set_bit(&value_one, 86, 1);
  ck_assert_int_eq(0, s21_add(value_one, value_two, &result));
}
...
START_TEST(mul_0) {
  ...
  s21_set_scale(&value_one, 28);
  set_bit(&value_one, 7 * 32 - 1, 1);
...
START_TEST(mul_1) {
  s21_decimal value_one = {{123, 456, 789, 0}},
              value_two = {{987, 654, 321, ~(UINT_MAX >> 1)}}, result = {{0}};
  set_bit(&value_two, 127, 1);
...
START_TEST(mul_6) {
  s21_decimal value_one = {{123, 456, 0, ~(UINT_MAX >> 1)}},
              value_two = {{987, 654, 321, 0}}, result = {{0}};
  set_bit(&value_one, 23, 1);
  ck_assert_int_eq(2, s21_mul(value_one, value_two, &result));
}
...
START_TEST(mul_7) {
  ...
  set_bit(&value_one, 33, 1);
  set_bit(&value_two, 22, 1);
...
START_TEST(mul_8) {
  s21_decimal value_one = {{UINT_MAX, UINT_MAX, UINT_MAX, ~(UINT_MAX >> 1)}},
              value_two = {{777, 0, 0, ~(UINT_MAX >> 1)}}, result = {{0}};
  ck_assert_int_eq(1, s21_mul(value_one, value_two, &result));
}
...
START_TEST(div_10) {
  s21_decimal value_one = {0}, value_two = {0}, result;
  set_bit(&value_one, 88, 1);
  set_bit(&value_two, 88, 1);
...
START_TEST(div_12) {
  s21_decimal value_one = {{50, 0, 0, 0}},
              value_two = {{10, 0, 0, ~(UINT_MAX >> 1)}}, result;
  ck_assert_int_eq(0, s21_div(value_one, value_two, &result));
}
...
START_TEST(div_13) {
  s21_decimal value_one = {{36, 0, 0, ~(UINT_MAX >> 1)}},
              value_two = {{2, 0, 0, ~(UINT_MAX >> 1)}}, result;
  set_bit(&value_one, 127, 1);
  ck_assert_int_eq(0, s21_div(value_one, value_two, &result));
}
...
START_TEST(div_14) {
  s21_decimal value_one = {{12, 23, 123, ~(UINT_MAX >> 1)}},
...
s21_decimal_suite(void) {
  ...
  tcase_add_test(tcase_core, s21_float_1);
